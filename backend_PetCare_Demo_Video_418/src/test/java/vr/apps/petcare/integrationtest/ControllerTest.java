...
class ControllerTest {
  ...
  void  testRetrieveMetadataDocument() {
    final String xml = given()
        .when()
        .get("/PetCare_Demo_Video/$metadata")
        .then()
        .statusCode(HttpStatusCode.OK.getStatusCode())
        .contentType(ContentType.XML)
        .extract()
    ...
    assertNotNull(n);
    assertEquals("PetCare_Demo_Video", n.getAttribute("Namespace"));
  ...
  void  testCreatePetServiceInstance() throws IOException {
    given()
        ...
        .when()
        .post("/PetCare_Demo_Video/PetServices")
        .then()
  ...
  given()
   ...
   given()
            .when()
            .get("/PetCare_Demo_Video/PetServices?$top=1")
            .then()
    ...
    given()
            .when()
            .get("/PetCare_Demo_Video/PetServices/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  void  testCreatePetOwnerInstance() throws IOException {
    given()
        ...
        .when()
        .post("/PetCare_Demo_Video/PetOwners")
        .then()
        .statusCode(HttpStatusCode.CREATED.getStatusCode());
  ...
  given()
   ...
   given()
            .when()
            .get("/PetCare_Demo_Video/PetOwners?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/PetCare_Demo_Video/PetOwners/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  void  testCreatePetCareCenterInstance() throws IOException {
    given()
        ...
        .when()
        .post("/PetCare_Demo_Video/PetCareCenters")
        .then()
        .statusCode(HttpStatusCode.CREATED.getStatusCode());
  ...
  given()
   ...
   given()
            .when()
            .get("/PetCare_Demo_Video/PetCareCenters?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/PetCare_Demo_Video/PetCareCenters/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  void  testCreateDocumentInstance() throws IOException {
    given()
        ...
        .when()
        .post("/PetCare_Demo_Video/Documents")
        .then()
        .statusCode(HttpStatusCode.CREATED.getStatusCode());
  ...
  given()
   ...
   given()
            .when()
            .get("/PetCare_Demo_Video/Documents?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/PetCare_Demo_Video/Documents/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  given()
   ...
   given()
            .when()
            .get("/PetCare_Demo_Video/Pets?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/PetCare_Demo_Video/Pets/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
